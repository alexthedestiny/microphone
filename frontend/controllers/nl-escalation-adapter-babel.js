    ...
    chatBot.subscriptions.onShowConversationWindow(function (next) {
    	setTimeout(function(){
    		if(!$('#inbenta-bot-input+div').is('.custom-input-wrapp')){
    			...
    			$('#inbenta-bot-input').after('<div class="custom-input-wrapp"><textarea type="text" class="custom-input" autocomplete="off" placeholder="Ask me" id="custom-input" rows="2"></textarea><button id="custom-send"><span class="custom-icon"></span></button></div>');
