...
angular.
module('addGiftcardPage')
.component('addGiftcardPage', {
  template: require('./add-giftcard-page.template.html'),
  controller: ['$translate', '$scope', '$rootScope', '$filter', '$mdDialog', 'Main', 'AdminService', '$stateParams', '$location',
  function addGiftcardPageController($translate, $scope, $rootScope, $filter, $mdDialog, Main, AdminService, $stateParams, $location) {
